<template>
    <div class="home">
        <header>
            <img src="../../../public/images/background_desktop.svg" alt="background_desktop.svg" class="d-none d-lg-block">
            <img src="../../../public/images/background_tablet.svg" alt="background_tablet.svg" class="d-none d-md-block d-lg-none">
            <img src="../../../public/images/background_mobile.svg" alt="background_mobile.svg" class="d-md-none d-lg-none">
        </header>
        <section class="container articles_section" id="articles_section">
            <h4 class="text-center py-4">Caută printre articolele disponibile și află lucruri practice.</h4>
            <div class="loader">
