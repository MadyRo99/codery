...
@section('title', 'Codery | Politică de confidențialitate')
...
@section('content')
    ...
    <div class="container legal-terms-section">
        ...
        <p>
            Rauden Games built the apps as a free apps. This Service is provided by Rauden Games at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <h2>Links to privacy policy of third party service providers used by the app:</h2>
        <ul>
        ...
        <h2>File usage</h2>
        <p>
            We use certain files to save application data to your device.
        </p>
        <h2>Security</h2>
        <p>
